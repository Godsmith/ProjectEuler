...
from pe58 import spiral_square, add_2_to_diameter_of_spiral_square, rotate_nested_list, get_spiral_square_diagonals
...
class TestGetSpiralSquareDiagonals(unittest.TestCase):
    def test_3(self):
        self.assertEquals({3, 5, 7, 9}, get_spiral_square_diagonals(3))

    def test_5(self):
        self.assertEquals({13, 17, 21, 25}, get_spiral_square_diagonals(5))
